...
table(dss9_data$tier2, dss9_data$azimuth_celltype_l1)

# Check IAE and IAF predicted classes by Azimuth
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAE", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAE 1", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAE 2", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAE 3", dss9_data$tier2))]), decreasing = TRUE)

sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAF", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAF 1", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAF 2", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAF 3", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("IAF 4", dss9_data$tier2))]), decreasing = TRUE)
sort(table(dss9_data$azimuth_celltype_l1[(grepl("Fibro 4", dss9_data$tier2))]), decreasing = TRUE)
...
anomaly_output <- detectAnomaly(query_data = dss9_data,
                                ...
                                query_cell_type_col = "azimuth_celltype_l1", 
                                ref_cell_type_col = "tier2", 
                                cell_types = c("Fibro 2", "Fibro 5", "Fibro 6", "Fibro 7", "Fibro 13",
                                              "SMC 1", "Pericyte 1",
                                              "Colonocytes"), 
                                pc_subset = 1:5,
                                n_tree = 500,
...
plot(gene_shifts,
     cell_type = "Fibro 6",
     pc_subset = 1:5,
     plot_type = c("heatmap", "boxplot", "barplot")[3],
