...
ggsave("figures/merfish/harmony_umap_1_by_disease.png", p_disease, width = 8, height = 6, dpi = 600)
ggsave("figures/merfish/harmony_umap_2_by_celltype.png", p_celltype, width = 10, height = 8, dpi = 600)
ggsave("figures/merfish/harmony_umap_3_by_ecm.png", p_ecm, width = 10, height = 8, dpi = 600)
