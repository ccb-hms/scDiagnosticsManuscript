...
fig_s2 <- ggplot(umap_data_ifn, aes(x = UMAP1, y = UMAP2, color = IFN_Score)) +
    ...
    theme_minimal() +
    theme(
        plot.title = element_text(hjust = 0.5, face = "bold", size = 24, color = "#1F2937", family = "sans"),
        ...
        legend.title = element_text(size = 20, face = "bold", color = "#374151"),
        legend.text = element_text(size = 18, color = "#4B5563"),
...
ggsave("figures/supp/covid/Fig_S3_ifn_signature.png", fig_s2, width = 12, height = 10, dpi = 600)
...
print("Supplementary Figure S3 (IFN Signature) complete!")
