...
message("Columns in query CSV: ", paste(colnames(query_df), collapse = ", "))
...
covid_data$scvi_confidence <- query_df$scvi_confidence
...
message("\n✓✓✓ scVI/scArches Integration Complete for both datasets! ✓✓✓")
