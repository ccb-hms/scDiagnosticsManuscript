...
final_plot <- (p_time | p_mem) + plot_layout(guides = "collect") & 
              theme(legend.position = "bottom", legend.title = element_blank())
print(final_plot)

ggsave("figures/supp/covid/Fig_S6_computing_benchmark.png", final_plot, width = 20, height = 10, dpi = 600)
