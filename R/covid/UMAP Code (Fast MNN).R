...
ggsave("figures/covid/fastmnn_umap_1_by_disease.png", p_disease, width = 10, height = 8, dpi = 300)
ggsave("figures/covid/fastmnn_umap_2_by_hybrid_celltype.png", p_celltype, width = 10, height = 8, dpi = 300)
ggsave("figures/covid/fastmnn_umap_3_by_ifn.png", p_ifn, width = 10, height = 8, dpi = 300)
