...
Identify which genes drive differences between query and reference.
...
- **Coordinated suppression** (entire pathway downregulated) = Likely biological dysregulation
- **Scattered patterns** = May indicate quality issues
...
- `calculateGeneShifts()` — Top-loading gene expression changes
