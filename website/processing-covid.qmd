...
This page describes the data processing workflow for the COVID-19 PBMC dataset. The raw data originates from [CZI CELLxGENE](https://cellxgene.cziscience.com/collections/ddfad306-714d-4cc0-9985-d9072820c530) and undergoes two processing steps to generate the final reference and query datasets used in the analysis.

## Data Source

The raw dataset is downloaded from CZI CELLxGENE:
...
The workflow consists of two sequential R scripts:

### Step 1: Data Cleaning and Subsetting

**File:** `R/covid/Data Cleaning and Metadata Removal.R`
...
Both output objects are `SingleCellExperiment` format with:
...
Rather than running this pipeline yourself, you can download the final processed datasets directly:
...
- Step 1: `R/covid/Data Cleaning and Metadata Removal.R`
- Step 2: `R/covid/Data QC and Processing.R`
