...
Query cells are annotated using [**SingleR**](https://bioconductor.org/packages/SingleR), a reference-based annotation tool that correlates query cell expression against reference pseudobulk profiles. This provides a practical test case for evaluating annotation diagnostics.
