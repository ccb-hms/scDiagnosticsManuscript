...
This repository contains the full computational workflow for the manuscript "*scDiagnostics: diagnostic tools for assessing cell type annotation in scRNA-seq data*" (Christidis et al.), which introduces and demonstrates the `scDiagnostics` R/Bioconductor package.
